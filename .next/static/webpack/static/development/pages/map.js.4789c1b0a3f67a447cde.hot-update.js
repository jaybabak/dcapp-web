...
function (_React$Component) {
  ...
  function Mappy(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "componentWillMount", function () {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.get('http://localhost:5000/stores').then(function (response) {// console.log(response);
        // this.setState({
        // 	data: response.data
        // });
        // this.setState({
...
//# sourceMappingURL=map.js.4789c1b0a3f67a447cde.hot-update.js.map