...
function (_React$Component) {
  ...
  _createClass(Mappy, [{
    ...
    value: function componentWillMount() {
      console.log('test'); // Make a request for a user with a given ID

      axios__WEBPACK_IMPORTED_MODULE_2___default.a.get('/user?ID=12345').then(function (response) {
...
//# sourceMappingURL=map.js.f71d65e6fde48da02e01.hot-update.js.map